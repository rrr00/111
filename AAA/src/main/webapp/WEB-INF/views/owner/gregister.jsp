                ...
                <div class="card mx-0 p-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row form-group">
                            ...
                            <input type="text" name="gname" class="form-control col-9 ml-4" style="margin-left: 15px;">
                        </div>

                        <div class="row form-group">
                            <label class="col-2">주&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;소</label>
                            <div class="input-group form-group col-9" id="addr">
                                <div class="form-inline row">
                                    <input type="text" name="zipNo" id="zipNo" class="form-control col-8 ml-5">
                                    <input type="button" value="주소검색" class="btn ml-2" onclick="goPopup();">
                                </div>
                                <div>
                                    <div class="row">
                                        <input type="text" name="roadAddrPart1" id="roadAddrPart1" class="form-control my-2 col-8 ml-5">
                                    </div>
                                </div>
                                <div class="form-inline row">
                                    <input type="text" name="addrDetail" id="addrDetail"class="form-control col-5 ml-5">
                                    <input type="text" name="roadAddrPart2" id="roadAddrPart2" class="form-control col-5 ml-2">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="btn-group-toggle col-9 form-inline" data-toggle="buttons">
                                <c:forEach items="${comflist }" var="comf" varStatus="status">
                                    ...
                                    <c:if test="${comf.cno ==6}">
                                        <input type="button" class="btn btn-info mr-2 mb-2" value="+" id="btn_etc">
                                        <div class="btn-group-toggle col-10 form-inline ml-0 px-0" data-toggle="buttons" id="comfort_etc">
                                    </c:if>
                                    <c:if test="${status.isLast() && comf.cno > 6  }">
                            </div>
                            </c:if>
                            </c:forEach>
                        </div>
                    ...
                    <div class="row form-group">
                        ...
                        <select name="rstime" class="form-control col-3" style="margin-left: 15px;">
                    ...
                    <div class="row form-group">
                        ...
                        <input type="text" class="form-control col-9"  style="margin-left: 15px;" placeholder="금액은 , 없이 입력해주세요">
                    </div>
                    <div class="row form-group">
                            <div class="col-2"></div>
                    ...
                    <div class="row form-group">
                        ...
                        <textarea rows="10" cols="50" class="form-control col-9 ml-3"placeholder="스마트에디터? ?"></textarea>
                    </div>
                    ...
                    <div class="row pull-right">
                        <input type="submit" class="btn btn-info m-2" value="등록하기" id="searchBtn">
                    </div>
